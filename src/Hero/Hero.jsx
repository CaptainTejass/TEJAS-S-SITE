    ...
    <div className="hero">
      <div className='wrapper'>
        <motion.div className='textContainer' variants={textVariants} initial="initial" animate="animate">
            <motion.h2 variants={textVariants}>MY EXPERTISE?</motion.h2>
            <motion.h1 variants={textVariants}>web Development & Data Analysis</motion.h1>
      ...
      <motion.div className='sliding_text__container' variants={sliderVariants} initial="initial" animate="animate">
         ...
         WEB DEVELOPER || DATA ANALYST || UI/UX
      </motion.div>
